...
class ProductionAI:
    ...
    def get_action(self, obs, action_id):
        ...
        #self.collector.log_step(obs.observation.game_loop, player.minerals, player.vespene, current_workers, ideal_workers, action_id)
...
def main(argv):
    ...
    with sc2_env.SC2Env(
        ...
        while True:
            ...
            while True:
                # 隨機選擇動作測試 (0-9)
                action_id = 3#random.randint(0, 9)
